...
<template>
    <AuthBase title="Crear una cuenta" description="Ingresa tus datos para registrarte">
        <Head title="Registro" />
        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="dni" type="text" required :tabindex="2" autocomplete="username" v-model="form.dni" placeholder="Ingresa tu DNI" />
